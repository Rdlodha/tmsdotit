                                ...
                                {task.image && (
                                    task.image.toLowerCase().endsWith(".pdf") ? (
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 text-xs text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg px-2 py-1.5 transition-colors"
                                            title="Open PDF"
                                        >
